...
/*   const [scope, animate] = useAnimate();
  ...
  return (
    <div className="z-20  h-full max-w-full items-center sm:max-w-5xl gap-8 my-8 sm:my-16 flex flex-col sm:flex-row sm:items-center sm:justify-between relative overflow-visible p-4 align-middle mx-auto py-12 sm:py-24">
      ...
      >
        <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold text-center sm:text-left bg-clip-text text-transparent bg-linear-to-b from-gray-900 to-gray-600 dark:from-neutral-50 dark:to-neutral-400 bg-opacity-50">
          Hello, I am {config.name} <br />{" "}
          <FlipWords
