    ...
    <div className="z-20 h-full max-w-full items-center sm:max-w-5xl flex flex-col sm:items-center sm:justify-center relative  align-middle mx-auto py-12 sm:py-24">
      ...
      <div className="flex h-full w-full items-center justify-center">
        <div className="grid h-full w-full gap-4  p-2 grid-cols-4 grid-rows-2 rounded-lg text-white">
          ...
          <div className="col-span-2 row-span-2 shadow-feature-card-dark bg-BlackRussian group rounded-lg  flex items-center justify-center overflow-hidden">
            <p>Pork</p>
          </div>

          <div className="col-span-1 row-span-2 shadow-feature-card-dark bg-BlackRussian group rounded-lg  flex items-center justify-center overflow-hidden">
            <p>Edamame</p>
          </div>
        </div>
      </div>
